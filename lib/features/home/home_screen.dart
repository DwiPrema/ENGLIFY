...
import 'package:project_englify/features/shared/widgets/effect_snap.dart';
    ...
    return Stack(
      children: [
        ...
        DraggableScrollableSheet(
          snap: true,
          snapSizes: [0.75, 1.0 - MediaQuery.of(context).padding.top],
            initialChildSize: 0.75,
            minChildSize: 0.75,
            maxChildSize: 1.0 - MediaQuery.of(context).padding.top,
